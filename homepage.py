...
def home():
    ...
    nodes.append(Node(id="Streamlit",
                      size=40,
                      shape="circularImage",
                      image="https://streamlit.io/sharing-image-facebook.jpg"))
    nodes.append(Node(id="Render",
                      size=40,
                      shape="circularImage",
                      image="https://s.yimg.com/ny/api/res/1.2/NUXmOpgkPolu9LpCpmiNbw--/YXBwaWQ9aGlnaGxhbmRlcjt3PTY0MDtoPTY0MA--/https://media.zenfs.com/en/business-wire.com/d383bb5d34a7801bc310303e5b0fb957"))
    edges.append(Edge(source="NextJS",
                      label="",
                      target="CraveFeed",
                      color="white"))
    edges.append(Edge(source="Streamlit",
                      label="",
                      target="CraveFeed",
                      color="white"))
    edges.append(Edge(source="Render",
                      label="",
                      target="CraveFeed",
                      color="white"))
